...
type CreatePaymentReq struct {
	...
	PayModel    string `protobuf:"bytes,2,opt,name=payModel,proto3" json:"payModel,omitempty"`       //支付方式
	PayTotal    int64  `protobuf:"varint,3,opt,name=payTotal,proto3" json:"payTotal,omitempty"`      //（支付总金额(分)
	OrderSn     string `protobuf:"bytes,4,opt,name=orderSn,proto3" json:"orderSn,omitempty"`         //业务单号
	ServiceType string `protobuf:"bytes,5,opt,name=serviceType,proto3" json:"serviceType,omitempty"` //业务类型
}
