...
var (
	...
	cacheOrderHomestayOrderIdPrefix = "cache:Order:homestayOrder:id:"
	cacheOrderHomestayOrderSnPrefix = "cache:Order:homestayOrder:sn:"
)
...
func (m *defaultHomestayOrderModel) Insert(ctx context.Context, session sqlx.Session, data *HomestayOrder) (sql.Result, error) {
	...
	OrderHomestayOrderIdKey := fmt.Sprintf("%s%v", cacheOrderHomestayOrderIdPrefix, data.Id)
	OrderHomestayOrderSnKey := fmt.Sprintf("%s%v", cacheOrderHomestayOrderSnPrefix, data.Sn)
	...
	}, OrderHomestayOrderIdKey, OrderHomestayOrderSnKey)
}

func (m *defaultHomestayOrderModel) FindOne(ctx context.Context, id int64) (*HomestayOrder, error) {
	looklookOrderHomestayOrderIdKey := fmt.Sprintf("%s%v", cacheOrderHomestayOrderIdPrefix, id)
...
func (m *defaultHomestayOrderModel) FindOneBySn(ctx context.Context, sn string) (*HomestayOrder, error) {
	OrderHomestayOrderSnKey := fmt.Sprintf("%s%v", cacheOrderHomestayOrderSnPrefix, sn)
	var resp HomestayOrder
	err := m.QueryRowIndexCtx(ctx, &resp, OrderHomestayOrderSnKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultHomestayOrderModel) Update(ctx context.Context, session sqlx.Session, newData *HomestayOrder) (sql.Result, error) {
	...
	looklookOrderHomestayOrderIdKey := fmt.Sprintf("%s%v", cacheOrderHomestayOrderIdPrefix, data.Id)
	looklookOrderHomestayOrderSnKey := fmt.Sprintf("%s%v", cacheOrderHomestayOrderSnPrefix, data.Sn)
	return m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
...
func (m *defaultHomestayOrderModel) Delete(ctx context.Context, session sqlx.Session, id int64) error {
	...
	OrderHomestayOrderIdKey := fmt.Sprintf("%s%v", cacheOrderHomestayOrderIdPrefix, id)
	OrderHomestayOrderSnKey := fmt.Sprintf("%s%v", cacheOrderHomestayOrderSnPrefix, data.Sn)
...
func (m *defaultHomestayOrderModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheOrderHomestayOrderIdPrefix, primary)
}
