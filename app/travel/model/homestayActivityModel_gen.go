...
var (
	...
	cacheTravelHomestayActivityIdPrefix = "cache:ravel:homestayActivity:id:"
)
...
func (m *defaultHomestayActivityModel) Insert(ctx context.Context, session sqlx.Session, data *HomestayActivity) (sql.Result, error) {
	...
	TravelHomestayActivityIdKey := fmt.Sprintf("%s%v", cacheTravelHomestayActivityIdPrefix, data.Id)
	...
	}, TravelHomestayActivityIdKey)
}

func (m *defaultHomestayActivityModel) FindOne(ctx context.Context, id int64) (*HomestayActivity, error) {
	TravelHomestayActivityIdKey := fmt.Sprintf("%s%v", cacheTravelHomestayActivityIdPrefix, id)
	var resp HomestayActivity
	err := m.QueryRowCtx(ctx, &resp, TravelHomestayActivityIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayActivityModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheTravelHomestayActivityIdPrefix, primary)
}
