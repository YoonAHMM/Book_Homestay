...
import (
	...
	"database/sql"
	"fmt"
	"Book_Homestay/common/mysql/genModel"
	"strings"
...
var (
	...
	cacheTravelHomestayBusinessIdPrefix     = "cache:Travel:homestayBusiness:id:"
	cacheTravelHomestayBusinessUserIdPrefix = "cache:Travel:homestayBusiness:userId:"
)
...
func (m *defaultHomestayBusinessModel) Insert(ctx context.Context, session sqlx.Session, data *HomestayBusiness) (sql.Result, error) {
	...
	TravelHomestayBusinessIdKey := fmt.Sprintf("%s%v", cacheTravelHomestayBusinessIdPrefix, data.Id)
	TravelHomestayBusinessUserIdKey := fmt.Sprintf("%s%v", cacheTravelHomestayBusinessUserIdPrefix, data.UserId)
	...
	}, TravelHomestayBusinessIdKey, TravelHomestayBusinessUserIdKey)
}

func (m *defaultHomestayBusinessModel) FindOne(ctx context.Context, id int64) (*HomestayBusiness, error) {
	TravelHomestayBusinessIdKey := fmt.Sprintf("%s%v", cacheTravelHomestayBusinessIdPrefix, id)
	var resp HomestayBusiness
	err := m.QueryRowCtx(ctx, &resp, TravelHomestayBusinessIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayBusinessModel) FindOneByUserId(ctx context.Context, userId int64) (*HomestayBusiness, error) {
	TravelHomestayBusinessUserIdKey := fmt.Sprintf("%s%v", cacheTravelHomestayBusinessUserIdPrefix, userId)
	var resp HomestayBusiness
	err := m.QueryRowIndexCtx(ctx, &resp, TravelHomestayBusinessUserIdKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultHomestayBusinessModel) UpdateWithVersion(ctx context.Context, session sqlx.Session, newData *HomestayBusiness) error {
	...
	looklookTravelHomestayBusinessIdKey := fmt.Sprintf("%s%v", cacheTravelHomestayBusinessIdPrefix, data.Id)
	looklookTravelHomestayBusinessUserIdKey := fmt.Sprintf("%s%v", cacheTravelHomestayBusinessUserIdPrefix, data.UserId)
...
func (m *defaultHomestayBusinessModel) Delete(ctx context.Context, session sqlx.Session, id int64) error {
	...
	looklookTravelHomestayBusinessIdKey := fmt.Sprintf("%s%v", cacheTravelHomestayBusinessIdPrefix, id)
	looklookTravelHomestayBusinessUserIdKey := fmt.Sprintf("%s%v", cacheTravelHomestayBusinessUserIdPrefix, data.UserId)
...
func (m *defaultHomestayBusinessModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheTravelHomestayBusinessIdPrefix, primary)
}
