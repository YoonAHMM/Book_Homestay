...
var (
	...
	cacheTravelHomestayCommentIdPrefix = "cache:Travel:homestayComment:id:"
)
...
func (m *defaultHomestayCommentModel) Insert(ctx context.Context, session sqlx.Session, data *HomestayComment) (sql.Result, error) {
	...
	TravelHomestayCommentIdKey := fmt.Sprintf("%s%v", cacheTravelHomestayCommentIdPrefix, data.Id)
	...
	}, TravelHomestayCommentIdKey)
}

func (m *defaultHomestayCommentModel) FindOne(ctx context.Context, id int64) (*HomestayComment, error) {
	TravelHomestayCommentIdKey := fmt.Sprintf("%s%v", cacheTravelHomestayCommentIdPrefix, id)
	var resp HomestayComment
	err := m.QueryRowCtx(ctx, &resp, TravelHomestayCommentIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayCommentModel) UpdateWithVersion(ctx context.Context, session sqlx.Session, data *HomestayComment) error {
	...
	looklookTravelHomestayCommentIdKey := fmt.Sprintf("%s%v", cacheTravelHomestayCommentIdPrefix, data.Id)
...
func (m *defaultHomestayCommentModel) Delete(ctx context.Context, session sqlx.Session, id int64) error {
	looklookTravelHomestayCommentIdKey := fmt.Sprintf("%s%v", cacheTravelHomestayCommentIdPrefix, id)
...
func (m *defaultHomestayCommentModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheTravelHomestayCommentIdPrefix, primary)
}
