...
var (
	...
	cacheTravelHomestayIdPrefix = "cache:Travel:homestay:id:"
)
...
func (m *defaultHomestayModel) Insert(ctx context.Context, session sqlx.Session, data *Homestay) (sql.Result, error) {
	...
	TravelHomestayIdKey := fmt.Sprintf("%s%v", cacheTravelHomestayIdPrefix, data.Id)
...
func (m *defaultHomestayModel) FindOne(ctx context.Context, id int64) (*Homestay, error) {
	TravelHomestayIdKey := fmt.Sprintf("%s%v", cacheTravelHomestayIdPrefix, id)
	var resp Homestay
	err := m.QueryRowCtx(ctx, &resp, TravelHomestayIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheTravelHomestayIdPrefix, primary)
}
